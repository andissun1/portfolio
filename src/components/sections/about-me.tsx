    ...
    <Container className="bg-gray-50" id="about">
      ...
      <div className="flex w-full flex-col justify-between gap-12 md:flex-row">
        ...
        <div className="flex max-w-xl flex-col gap-6">
          ...
          <Typography>
            Я увлечённый разработчик‑самоучка, специализирующийся на full-stack разработке
          ...
          <Typography>
            ...
            развиваюсь: берусь за новые задачи и осваиваю современные технологии. Спустя
            год после старта я создаю передовые веб‑приложения с использованием
            востребованных инструментов, таких как Redux, TypeScript, Tailwind CSS и
            многих других.
          </Typography>
          <Typography>
          ...
          <Typography>И напоследок — несколько коротких фактов обо мне.</Typography>
          <div className="flex flex-col gap-2 md:flex-row md:gap-6">
            <ul className="flex list-inside list-disc flex-col gap-2">
              <Typography component="li">Побеждал на хакатонах</Typography>
              <Typography component="li">Любитель видеоигр</Typography>
            </ul>
            <ul className="flex list-inside list-disc flex-col gap-2">
              <Typography component="li">Сам из Мурманска</Typography>
              <Typography component="li">Не имею питомцев</Typography>
            </ul>
          </div>
          <Typography>
